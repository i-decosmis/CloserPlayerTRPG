...
* Il mio tablet non riesce a stare acceso per tutta la durata di una sessione, quindi ha bisogno di essere caricato. Per non aggiungere altri cavi ho deciso di cambiare l'alimentazione in 12V 2A e utilizzare uno step down a 5V 5A e poter alimentare sia il 28byj-48 che il tablet.
